...
export function SecaoFicha({ titulo, icon: Icon, acao, className, children, primeira }: SecaoFichaProps) {
  return (
    <div className={`${primeira ? '' : 'mt-6 pt-6 border-t border-zinc-800/70'} ${className || ''}`}>
      <div className="flex items-center justify-between gap-3 mb-3">
        <h3 className="flex items-center gap-1.5 text-[11px] font-semibold uppercase tracking-[0.08em] text-zinc-400">
