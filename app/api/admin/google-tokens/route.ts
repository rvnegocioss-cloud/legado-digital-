...
import { criptografarToken } from '@/lib/googleTokenCrypto'
    ...
    .upsert(
      {
        ...
        provider_token: criptografarToken(providerToken),
        provider_refresh_token: providerRefreshToken ? criptografarToken(providerRefreshToken) : null,
        escopos: escopos || '',
