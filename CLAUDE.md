...
- [ ] UI de moderação do mural de memórias não existe pra ninguém — permissão de DELETE já liberada pro parceiro dono no banco (2026-07-27), falta o botão em algum lugar (Central também não tem)
