...
8. [ ] **Landing page no padrão do projeto** (regra do Rafael, 2026-07-14) — depois de tudo acima, revisar a landing pra usar o mesmo template/cor/fonte já padronizado no resto (navy `#0B1D2A` + dourado `#C9A46A`), não a paleta separada que `app/globals.css` ainda tem pra ela (`--primary: #1a1a2e`, `--secondary: #e2b714`, fonte Inter/Playfair Display) — hoje landing e resto do produto têm 2 identidades visuais diferentes.
